...
public class RoutePersistenceMapper {
    ...
    public TripAssignmentRecord toAssignmentRecord(TripAssignmentEntity assignment) {
        return TripAssignmentRecord.builder()
                ...
                .successCode(assignment.getSuccessCode())
                .successDescription(assignment.getSuccessDescription())
                .failCode(assignment.getFailCode())
                .failDescription(assignment.getFailDescription())
    ...
    public TripAssignmentEntity toEntity(TripAssignmentRecord record) {
        return TripAssignmentEntity.builder()
                ...
                .successCode(record.getSuccessCode())
                .successDescription(record.getSuccessDescription())
                .failCode(record.getFailCode())
                .failDescription(record.getFailDescription())
