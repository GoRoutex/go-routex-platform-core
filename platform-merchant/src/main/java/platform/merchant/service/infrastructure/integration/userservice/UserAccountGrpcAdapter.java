...
import platform.core.common.service.FetchUserAccountByEmailRequest;
...
import platform.merchant.service.domain.user.model.UserStatus;
...
public class UserAccountGrpcAdapter implements UserRepositoryPort {
    ...
    public Optional<User> findByEmail(String email) {
        try {
            FetchUserAccountResponse response = userAdminGrpcServiceStub.fetchUserAccountByEmail(
                    FetchUserAccountByEmailRequest.newBuilder()
    ...
    private Optional<User> handleLookupException(StatusRuntimeException ex) {
